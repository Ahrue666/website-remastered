  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        <a href="#home" className="font-display text-xl font-bold tracking-wider text-gradient-ember">
          AHRUE LUSTER
        </a>
            ...
            <div className="flex flex-col items-center gap-6 py-8">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-base font-display tracking-wider text-muted-foreground hover:text-foreground transition-colors uppercase"
                >
                  {link.label}
                </a>
              ))}
